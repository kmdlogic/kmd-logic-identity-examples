...
export class AuthorizeService {
    ...
    async ensureUserManagerInitialized() {
        ...
        let settings = {
            ...
            redirect_uri: window.appConfig.RedirectUri,
            post_logout_redirect_uri: window.appConfig.PostLogoutRedirectUri,
            response_type: window.appConfig.ResponseType,
            scope: window.appConfig.Scope,
            loadUserInfo: false
         };
